...
movies = pd.read_csv(r"tmdb_5000_movies.csv", encoding='ISO-8859-1', sep=',', on_bad_lines='skip')
credits = pd.read_csv(r"tmdb_5000_credits.csv", encoding='ISO-8859-1', sep=',', on_bad_lines='skip')
